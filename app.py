...
<div class="hero">
  ...
  <p>Paste the product once. The app writes the Script DNA voiceover, audits it for TikTok Shop compliance, lets you save and recall scripts, then creates and cleans the ElevenLabs audio.</p>
